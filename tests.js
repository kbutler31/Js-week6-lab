...
describe('JS6 Lab Tests:', () => {
  describe('Example Question Test: Add Two Numbers', () => {
    ...
    describe(`Question:1a: Sorted array of numbers:`, () => {
        it(`#Should return an array of ascending numbers`, () => {
    ...
    describe(`Question 1b: Manage my wallet`, () => {
        it(`#Should be able to add and withdraw money from wallet`, () => {
            class Wallet {
            ...
            myWallet.addMoney(10)
                ...
                expect(myWallet).to.equal(110)
              })
              it(`Should be able to remove money from my wallet`, () => {
                let myWallet = new Wallet (110)
                myWallet.removeMoney(20)

                expect(myWallet).to.equal(90)
              })
        })
    })
  })
  describe(`Question 1c: Day of the Week`, () => {
    it(`#Should be able to filter through the case to find the day of the week`, () => {
...
describe(`Question 1d: Only wizards shall pass!`, () => {
    it(`#Should only pass wizards`, () => {
        const movieCharacters = [
          ...
          it(`#Should return an array of object... object.isWizard should be true`, () => {
